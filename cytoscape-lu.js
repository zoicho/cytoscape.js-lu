(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["cytoscapeLu"] = factory();
	else
		root["cytoscapeLu"] = factory();
})(self, () => {
...
var generalUtils = {};
var polyominoPacking = __webpack_require__(442);
const { Point } = __webpack_require__(442);
...
var __WEBPACK_AMD_DEFINE_RESULT__;(function () {
  ...
  var register = function (cytoscape) {
    ...
    var layoutUtilities = __webpack_require__(995);
...
var generalUtils = __webpack_require__(934);
var polyominoPacking = __webpack_require__(442);
const { Point, Polyomino } = __webpack_require__(442);
const { getCenter } = __webpack_require__(934);
const pose = __webpack_require__(595);
...
/******/ 	function __nested_webpack_require_337928__(moduleId) {
...
/******/ 		__webpack_modules__[moduleId].call(module.exports, module, module.exports, __nested_webpack_require_337928__);
/******/ 	
...
/******/ 		__nested_webpack_require_337928__.d = (exports, definition) => {
/******/ 			for(var key in definition) {
/******/ 				if(__nested_webpack_require_337928__.o(definition, key) && !__nested_webpack_require_337928__.o(exports, key)) {
...
/******/ 	(() => {
/******/ 		__nested_webpack_require_337928__.o = (obj, prop) => (Object.prototype.hasOwnProperty.call(obj, prop))
/******/ 	})();
/******/ 	
/******/ 	/* webpack/runtime/make namespace object */
/******/ 	(() => {
/******/ 		// define __esModule on exports
/******/ 		__nested_webpack_require_337928__.r = (exports) => {
...
"use strict";
// ESM COMPAT FLAG
__nested_webpack_require_337928__.r(__nested_webpack_exports__);

// EXPORTS
__nested_webpack_require_337928__.d(__nested_webpack_exports__, {
  DEFAULT_OPTIONS: () => (/* binding */ DEFAULT_OPTIONS),
  DistanceDetectionType: () => (/* binding */ DistanceDetectionType),
  constructEdges: () => (/* binding */ constructEdges),
  getFrame: () => (/* binding */ getFrame),
  packComponents: () => (/* binding */ packComponents)
});
...
var Polygon = /** @class */ (function () {
    function Polygon(mPoints) {
        ...
        try {
            for (var _b = tslib_es6_values(this.mPoints), _c = _b.next(); !_c.done; _c = _b.next()) {
                var p = _c.value;
    ...
    Polygon.fromGraph = function (graph) {
        ...
        var points = [];
        try {
            for (var _b = tslib_es6_values(graph.nodes), _c = _b.next(); !_c.done; _c = _b.next()) {
                var node = _c.value;
    ...
    Polygon.convexHull = function (points) {
        ...
        try {
            for (var uniques_1 = tslib_es6_values(uniques), uniques_1_1 = uniques_1.next(); !uniques_1_1.done; uniques_1_1 = uniques_1.next()) {
...
function convexMinkowskiSum(A, B) {
    ...
    var points = [];
    try {
        for (var _c = tslib_es6_values(A.points), _d = _c.next(); !_d.done; _d = _c.next()) {
            var p1 = _d.value;
            try {
                for (var _e = (e_2 = void 0, tslib_es6_values(B.points)), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var p2 = _f.value;
...
var convexPolygonDistance = function (p, q, strategy) {
    ...
    switch (strategy) {
        case DistanceCalculationStrategy.BruteForce:
            ...
            var poly_1 = Polygon.fromPoints(msum);
...
var turfPoly = function (poly) {
    ...
    return polygon([toGeoJSON(__spread(pPoints, [pPoints[0]]))]);
};
...
var jsts_min = __nested_webpack_require_337928__(39);
...
;// CONCATENATED MODULE: ./node_modules/@turf/truncate/main.es.js
...
/* harmony default export */ const main_es = (truncate);
...
;// CONCATENATED MODULE: ./node_modules/@turf/clean-coords/main.es.js
...
function cleanCoords(geojson, options) {
    ...
    if (geojson.coordinates) {
        ...
        return main_es_feature({type: type, coordinates: newCoords}, geojson.properties, geojson.bbox, geojson.id);
    }
}
...
/* harmony default export */ const clean_coords_main_es = (cleanCoords);

;// CONCATENATED MODULE: ./node_modules/@turf/intersect/main.es.js
...
function intersect(poly1, poly2) {
    ...
    if (clean_coords_main_es(main_es(geom2, {precision: 4})).coordinates[0].length < 4) return null;
    if (clean_coords_main_es(main_es(geom1, {precision: 4})).coordinates[0].length < 4) return null;

    var reader = new jsts_min.GeoJSONReader();
    var a = reader.read(main_es(geom1));
    var b = reader.read(main_es(geom2));
    var intersection = jsts_min.OverlayOp.intersection(a, b);
    ...
    return main_es_feature(geom);
}

/* harmony default export */ const intersect_main_es = (intersect);
...
var basicEmbed = function (components, options) {
    ...
    var displacementWrapper = function (p1Index, p2Index, f) {
        var _a = tslib_es6_read([components.nodes[p1Index], components.nodes[p2Index]], 2), p1 = _a[0], p2 = _a[1];
        var intersectionPoly = intersect_main_es(turfPoly(p1), turfPoly(p2));
    ...
    var applyAttractiveForces = function (components, forces, intersectionForces) {
        var e_1, _a, e_2, _b;
        try {
            for (var _c = tslib_es6_values(components.edges.entries()), _d = _c.next(); !_d.done; _d = _c.next()) {
                var _e = tslib_es6_read(_d.value, 2), from = _e[0], neighbors = _e[1];
                try {
                    for (var neighbors_1 = (e_2 = void 0, tslib_es6_values(neighbors)), neighbors_1_1 = neighbors_1.next(); !neighbors_1_1.done; neighbors_1_1 = neighbors_1.next()) {
...
class Voronoi {
  ...
  *cellPolygons() {
  ...
  cellPolygon(i) {
    const polygon = new polygon_Polygon;
...
var findNeighbors = function (frame, centers) {
    ...
    var delaunay = Delaunay.from(centersMapped);
    ...
    for (var i = 0; i < centers.length; ++i) {
        try {
            for (var _b = (e_1 = void 0, tslib_es6_values(voronoi.neighbors(i))), _c = _b.next(); !_c.done; _c = _b.next()) {
...
var componentToPolygon = function (component) {
    ...
    var vertices = [];
    try {
        for (var _b = tslib_es6_values(component.nodes), _c = _b.next(); !_c.done; _c = _b.next()) {
            var node = _c.value;
...
var getFrame = function (polygons) {
    ...
    try {
        for (var polygons_1 = tslib_es6_values(polygons), polygons_1_1 = polygons_1.next(); !polygons_1_1.done; polygons_1_1 = polygons_1.next()) {
...
var constructEdges = function (polygons) {
    ...
    for (var i = 0; i < neighbors.length; ++i) {
        try {
            ...
            for (var _b = (e_3 = void 0, tslib_es6_values(neighbors[i])), _c = _b.next(); !_c.done; _c = _b.next()) {
                var neighbor = _c.value;
...
var calculateIdealDistance = function (components) {
    ...
    var len = 0;
    try {
        for (var components_1 = tslib_es6_values(components), components_1_1 = components_1.next(); !components_1_1.done; components_1_1 = components_1.next()) {
            var component = components_1_1.value;
            // Choose first edge of first node from each component
            if (component.edges.length > 0) {
                len += 1;
                var edge = component.edges[0];
                var edgeLength = Math.sqrt(distance({ x: edge.startX, y: edge.startY }, { x: edge.endX, y: edge.endY }));
